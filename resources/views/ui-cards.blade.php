                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-3">
                                ...
                                <div class="card">
                                    <img class="card-img-top img-fluid" src="{!! url('resources/images/gallery/2.jpg') !!}" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title">Card title</h4>
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up the bulk of the card's content.</p>
                            ...
                            <div class="col-md-6 col-xl-3">
                                ...
                                <div class="card">
                                    ...
                                    <img class="img-fluid" src="{!! url('resources/images/gallery/4.jpg') !!}" alt="Card image cap">
                                    <div class="card-body">
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up the bulk of the card's content.</p>
                                        <a href="#" class="card-link">Card link</a>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card">
                                    <img class="card-img-top img-fluid" src="{!! url('resources/images/gallery/5.jpg') !!}" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title">Card title</h4>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <img class="card-img-bottom img-fluid" src="{!! url('resources/images/gallery/7.jpg') !!}" alt="Card image cap">
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="card card-inverse text-white">
                                    <img class="card-img img-fluid" src="{!! url('resources/images/gallery/6.jpg') !!}" alt="Card image">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card-group">
                                    <div class="card mb-4">
                                        <img class="card-img-top img-fluid" src="{!! url('resources/images/gallery/8.jpg') !!}" alt="Card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title">Card title</h4>
                                            <p class="card-text">This is a wider card with supporting text below as a
                                                natural lead-in to additional content. This content is a little bit
                                    ...
                                    <div class="card mb-4">
                                        <img class="card-img-top img-fluid" src="{!! url('resources/images/gallery/9.jpg') !!}" alt="Card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title">Card title</h4>
                                    ...
                                    <div class="card mb-4">
                                        <img class="card-img-top img-fluid" src="{!! url('resources/images/gallery/10.jpg') !!}" alt="Card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title">Card title</h4>
                                            <p class="card-text">This is a wider card with supporting text below as a
                        ...
                        <div class="row m-b-20">
                            <div class="col-12">
                                ...
                                <div class="card-deck-wrapper">
                                    <div class="card-deck">
                                        <div class="card mb-4">
                                            <img class="card-img-top img-fluid" src="{!! url('resources/images/gallery/11.jpg') !!}" alt="Card image cap">
                                            <div class="card-body">
                                                <h4 class="card-title">Card title</h4>
                                        ...
                                        <div class="card mb-4">
                                            <img class="card-img-top img-fluid" src="{!! url('resources/images/gallery/12.jpg') !!}" alt="Card image cap">
                                            <div class="card-body">
                                                <h4 class="card-title">Card title</h4>
                                                <p class="card-text">This card has supporting text below as a natural
                                                    lead-in to additional content.</p>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card-columns">
                                    ...
                                    <div class="card">
                                        <img class="card-img img-fluid" src="{!! url('resources/images/gallery/4.jpg') !!}" alt="Card image cap">
                                    </div>
                                    <div class="card card-body text-right">
                                        <blockquote class="card-bodyquote mb-0">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
