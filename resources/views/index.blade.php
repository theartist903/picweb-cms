                                ...
                                <div class="card-box">
                                    ...
                                    <div class="inbox-widget">
                                        ...
                                        <div class="inbox-item">
                                            <a href="#">
                                                <div class="inbox-item-img"><img src="{!! url("resources/images/users/user-1.jpg")!!}" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <a href="#">
                                                <div class="inbox-item-img"><img src="{!! url("resources/images/users/user-2.jpg")!!}" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                                <a href="#">
                                                <div class="inbox-item-img"><img src="{!! url("resources/images/users/user-3.jpg")!!}" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <a href="#">
                                                <div class="inbox-item-img"><img src="{!! url("resources/images/users/user-4.jpg")!!}" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <a href="#">
                                                <div class="inbox-item-img"><img src="{!! url("resources/images/users/user-5.jpg")!!}" class="rounded-circle" alt=""></div>
