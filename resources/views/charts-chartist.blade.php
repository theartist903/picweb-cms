...
@section('footer_files')
    <script src="{!!url('resources/libs/chartist/chartist.min.js')!!}"></script>
    <script src="{!!url('resources/libs/chartist/chartist-plugin-tooltip.min.js')!!}"></script>

    <script src="{!! url('resources/js/pages/chartist.init.js') !!}"></script>
@endsection
