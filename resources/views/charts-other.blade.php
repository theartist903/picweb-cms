...
@section('footer_files')
    ...
    <script src="{!!url('resources/libs/jquery-sparkline/jquery.sparkline.min.js')!!}"></script>

    <script src="{!! url('resources/js/pages/charts-other.init.js') !!}"></script>

    <script src="{!!url('resources/libs/peity/jquery.peity.min.js')!!}"></script>
@endsection
