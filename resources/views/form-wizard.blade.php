...
@section('footer_files')
    <script src="{!! url('resources/libs/twitter-bootstrap-wizard/jquery.bootstrap.wizard.min.js') !!}"></script>
    <script src="{!! url('resources/js/pages/form-wizard.init.js') !!}"></script>
@endsection
