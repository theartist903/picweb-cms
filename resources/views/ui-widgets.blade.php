                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box">
                                    ...
                                    <div class="widget-chart-1">
                                        ...
                                        <div class="widget-detail-1 text-right">
                                            <h2 class="font-weight-normal pt-2 mb-1"> 8545 </h2>
                                            <p class="text-muted mb-1">Revenue today</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box">
                                    ...
                                    <div class="widget-chart-1">
                                        ...
                                        <div class="widget-detail-1 text-right">
                                            <h2 class="font-weight-normal pt-2 mb-1"> 3562 </h2>
                                            <p class="text-muted mb-1">Revenue today</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card-box widget-user">
                                    <div class="media">
                                        <div class="avatar-lg mr-3">
                                            <img src="{!! url('resources/images/users/user-3.jpg') !!}" class="img-fluid rounded-circle" alt="user">
                                        </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box widget-user">
                                    <div class="media">
                                        <div class="avatar-lg mr-3">
                                            <img src="{!! url('resources/images/users/user-2.jpg') !!}" class="img-fluid rounded-circle" alt="user">
                                        </div>
                                        <div class="media-body overflow-hidden">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box widget-user">
                                    <div class="media">
                                        <div class="avatar-lg mr-3">
                                            <img src="{!! url('resources/images/users/user-1.jpg') !!}" class="img-fluid rounded-circle" alt="user">
                                        </div>
                                        <div class="media-body overflow-hidden">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box widget-user">
                                    <div class="media">
                                        <div class="avatar-lg mr-3">
                                            <img src="{!! url('resources/images/users/user-10.jpg') !!}" class="img-fluid rounded-circle" alt="user">
                                        </div>
                                        <div class="media-body overflow-hidden">
                        ...
                        <div class="row">
                                ...
                                <div class="card-box">
                                    ...
                                    <ul class="list-group mb-0 user-list">
                                        <li class="list-group-item">
                                            <a href="#" class="user-list-item">
                                                <div class="user avatar-sm float-left mr-2">
                                                    <img src="{!! url('resources/images/users/user-2.jpg') !!}" alt="" class="img-fluid rounded-circle">
                                                </div>
                                                <div class="user-desc">
                                        ...
                                        <li class="list-group-item">
                                            <a href="#" class="user-list-item">
                                                <div class="user avatar-sm float-left mr-2">
                                                    <img src="{!! url('resources/images/users/user-3.jpg') !!}" alt="" class="img-fluid rounded-circle">
                                                </div>
                                                <div class="user-desc">
                                        ...
                                        <li class="list-group-item">
                                            <a href="#" class="user-list-item">
                                                <div class="user avatar-sm float-left mr-2">
                                                    <img src="{!! url('resources/images/users/user-5.jpg') !!}" alt="" class="img-fluid rounded-circle">
                                                </div>
                                                <div class="user-desc">
                                        ...
                                        <li class="list-group-item">
                                            <a href="#" class="user-list-item">
                                                <div class="user avatar-sm float-left mr-2">
                                                    <img src="{!! url('resources/images/users/user-6.jpg') !!}" alt="" class="img-fluid rounded-circle">
                                                </div>
                                                <div class="user-desc">
                                                    <h5 class="name mt-0 mb-1">Michael Zenaty</h5>
                                        ...
                                        <li class="list-group-item">
                                            <a href="#" class="user-list-item">
                                                <div class="user avatar-sm float-left mr-2">
                                                    <img src="{!! url('resources/images/users/user-1.jpg') !!}" alt="" class="img-fluid rounded-circle">
                                                </div>
                                                <div class="user-desc">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="text-center card-box">
                                    ...
                                    <div>
                                        <img src="{!! url('resources/images/users/user-9.jpg') !!}" class="rounded-circle avatar-xl img-thumbnail mb-3" alt="profile-image">
                                        ...
                                        <div class="text-left">
                                            ...
                                            <p class="text-muted font-13 m-b-5"><strong>Location :</strong> <span class="ml-2">USA</span></p>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box">
                                    ...
                                    <h5 class="mt-0">iMacs <span class="text-primary float-right">80%</span></h5>
                                    ...
                                    <h5 class="mt-0">iBooks <span class="text-pink float-right">50%</span></h5>
                                    ...
                                    <h5 class="mt-0">iPhone 5s <span class="text-info float-right">70%</span></h5>
                                    ...
                                    <h5 class="mt-0">iPhone 6 <span class="text-warning float-right">65%</span></h5>
                                    ...
                                    <h5 class="mt-0">iPhone 4 <span class="text-danger float-right">65%</span></h5>
                                    ...
                                    <h5 class="mt-0">iPhone 6s <span class="text-success float-right">40%</span></h5>
...
@section('footer_files')
    <script src="{!!url('resources/libs/jquery-knob/jquery.knob.min.js')!!}"></script>
@endsection
