                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="mt-0 header-title"><b>Stack Table</b></h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="mt-0 header-title"><b>Sortable Table</b></h4>
                                    <p class="text-muted font-13">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="mt-0 header-title"><b>Swipe Table</b></h4>
                                    <p class="text-muted font-13">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="mt-0 header-title"><b>Swipe Table with Mini Map</b></h4>
                                    <p class="text-muted font-13">
                                        Your awesome text goes here.
                                    </p>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="mt-0 header-title"><b>Column Toggle Table</b></h4>
                                    <p class="text-muted font-13">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="mt-0 header-title"><b>Column Toggle Table with Mini Map</b></h4>
                                    <p class="text-muted font-13">
                                        The Column Toggle Table allows the user to select which columns they want to be visible.
                                    </p>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="mt-0 header-title"><b>Mode Switch Table</b></h4>
                                    <p class="text-muted font-13">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="mt-0 header-title"><b>Bare Table</b></h4>
                                    <p class="text-muted font-13">
                                        Your awesome text goes here.
                                    </p>
...
@section('footer_files')
    <!-- Tablesaw js -->
    <script src="{!! url('resources/libs/tablesaw/tablesaw.js') !!}"></script>
    <!-- Init js -->
    <script src="{!! url('resources/js/pages/tablesaw.init.js') !!}"></script>
@endsection
